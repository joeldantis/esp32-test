...
CytronMD motor(PWM_DIR, 19, 18);  // PWM = Pin 3, DIR = Pin 4.
...
void loop() {
  ...
  motor.setSpeed(150);  // Run forward at full speed.
  delay(1000);

  motor.setSpeed(0);    // Stop.
  delay(1000);

  motor.setSpeed(-50);  // Run backward at 50% speed.
  delay(1000);
  
  motor.setSpeed(-150);  // Run backward at full speed.
  delay(1000);
